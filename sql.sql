...
('NV01','827ccb0eea8a706c4c34a16891f84e7b',N'Nguyễn Ngọc Tú Anh',N'Nữ',N'TP.HCM',STR_TO_DATE('23/04/1999','%d/%m/%Y'),STR_TO_DATE('14/03/2019','%d/%m/%Y'),'0234327865',2000000),
('NV02','827ccb0eea8a706c4c34a16891f84e7b',N'Dương ĐÔng Duy',N'Nam',N'Tiền Giang',STR_TO_DATE('06/12/2001','%d/%m/%Y'),STR_TO_DATE('14/06/2020','%d/%m/%Y'),'0382762835',2300000),
('NV03','827ccb0eea8a706c4c34a16891f84e7b',N'Điêu Ngọc Trinh',N'Nữ',N'TP.HCM',STR_TO_DATE('17/10/2001','%d/%m/%Y'),STR_TO_DATE('20/03/2020','%d/%m/%Y'),'05097362749',2300000),
('NV04','827ccb0eea8a706c4c34a16891f84e7b',N'Lê Xuân Bắc',N'Nam',N'Đắk Lắk',STR_TO_DATE('05/06/2001','%d/%m/%Y'),STR_TO_DATE('15/03/2019','%d/%m/%Y'),'0234327865',2000000),
('NV05','827ccb0eea8a706c4c34a16891f84e7b',N'Nguyễn Thị Thảo Vy',N'Nữ',N'Tiền Giang',STR_TO_DATE('03/02/2001','%d/%m/%Y'),STR_TO_DATE('03/03/2019','%d/%m/%Y'),'0353676482',2000000),
('NV06','827ccb0eea8a706c4c34a16891f84e7b',N'Ngô Thanh Huyền',N'Nữ',N'Quảng Bình',STR_TO_DATE('10/03/2001','%d/%m/%Y'),STR_TO_DATE('03/12/2018','%d/%m/%Y'),'0583527543',2000000),
('NV07','827ccb0eea8a706c4c34a16891f84e7b',N'Võ Thị Thu Hà',N'Nữ',N'Bình Định',STR_TO_DATE('10/03/2001','%d/%m/%Y'),STR_TO_DATE('30/3/2019','%d/%m/%Y'),'0738456281',5000000),
('NV08','827ccb0eea8a706c4c34a16891f84e7b',N'Trần Tuấn Anh',N'Nam',N'Long An',STR_TO_DATE('07/12/2000','%d/%m/%Y'),STR_TO_DATE('08/03/2020','%d/%m/%Y'),'0487362873',2000000),
('NV09','827ccb0eea8a706c4c34a16891f84e7b',N'Lưu Thanh Bình',N'Nam',N'Phú Yên',STR_TO_DATE('28/02/1999','%d/%m/%Y'),STR_TO_DATE('23/09/2020','%d/%m/%Y'),'0387529267',2000000),
('NV10','827ccb0eea8a706c4c34a16891f84e7b',N'Vũ Thị Thanh Danh',N'Nữ',N'TP.HCM',STR_TO_DATE('04/05/1999','%d/%m/%Y'),STR_TO_DATE('23/03/2020','%d/%m/%Y'),'0473526483',2000000);
-- ---BẢNG LOAIKH
