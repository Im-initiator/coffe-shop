...
public class quanlynhapkho extends javax.swing.JFrame {
     ...
     */
    ArrayList<nhapKho> ds;
    DefaultTableModel modelTBNK;
    DefaultTableModel modelTBCTNK;
    ...
    public quanlynhapkho(String tentk) {
        initComponents();
        this.tentk = tentk;
        txtTuKhoa.requestFocus();
        setResizable(false);
        setLocationRelativeTo(null);
        modelTBNK = (DefaultTableModel) tbNK.getModel();
        modelTBCTNK = (DefaultTableModel) tbCTNK.getModel();
        loadData();
        lbThongBao.setText("");
        lbThongBao1.setText("");
        HEIGHT = getHeight();
    ...
    void loadData() {
        tongTien = 0;
        ds = nhapKhoDAO.getdsNK();
        modelTBNK.setRowCount(0);
        SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        for (nhapKho hd : ds) {
            Vector r = new Vector();
            r.add(hd.getMaNhap());
            r.add(df.format(hd.getNgayNhap()));
            r.add(hd.getThanhTien());
    ...
    private void initComponents() {
        ...
        tbNK.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        tbNK.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Mã nhập", "Ngày nhập", "Thanh toán", "Nhân Viên"
            }
        ));
        tbNK.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tbNKMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tbNKMouseReleased(evt);
            }
        });
        tbNK.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbNKKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tbNK);
        ...
        lbTitle.setForeground(new java.awt.Color(255, 255, 0));
        lbTitle.setText("DANH SÁCH CHI TIẾT HOÁ ĐƠN");

        tbCTNK.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        tbCTNK.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Tên nước", "Số lượng", "Giá nhập", "Thành tiền"
            }
        ));
        tbCTNK.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tbCTNKMouseReleased(evt);
            }
        });
        tbCTNK.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbCTNKKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(tbCTNK);
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        modelTBNK.setRowCount(0);
        tongTien = 0;
        ArrayList<nhapKho> dshd = nhapKhoDAO.timKiem(txtTuKhoa.getText().trim());
        for (nhapKho hd : dshd) {
            Vector r = new Vector();
            r.add(hd.getMaNhap());
            r.add(df.format(hd.getNgayNhap()));
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // TODO add your handling code here:
        int row = tbNK.getSelectedRow();
        if (row >= 0) {
            if (JOptionPane.showConfirmDialog(null, "Bạn muốn xoá phiếu nhập với mã " + modelTBNK.getValueAt(row, 0).toString(), "Thông báo", JOptionPane.YES_NO_OPTION, 1) == JOptionPane.YES_OPTION) {
                int i = nhapKhoDAO.xoaPN(modelTBNK.getValueAt(row, 0).toString().trim());
                if (i != -1) {
            ...
            JOptionPane.showMessageDialog(null, "Mời bạn chọn phiếu nhập để xoá", "Thông báo", 1);
        }
    ...
    private void btnTimKiem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiem1ActionPerformed
        ...
        modelTBCTNK.setRowCount(0);
        ArrayList<chiTietNK> dsctnk = chiTietNKDAO.timKiem(txtTuKhoa1.getText(), modelTBNK.getValueAt(tbNK.getSelectedRow(), 0).toString());
        for (chiTietNK ct : dsctnk) {
            Vector r = new Vector();
            r.add(nuocUongDAO.timTenNuocTheoMa(ct.getMaNuoc()));
            r.add(ct.getSoLuong());
            r.add(ct.getGiaNhap());
            r.add(ct.getThanhTien());
            modelTBCTNK.addRow(r);
        }
        lbThongBao1.setText("KẾT QUẢ TÌM KIẾM:" + dsctnk.size());
    }//GEN-LAST:event_btnTimKiem1ActionPerformed
    void loadCTHD(String tukhoa) {
        modelTBCTNK.setRowCount(0);
        ArrayList<chiTietNK> dscthd = chiTietNKDAO.timKiem(tukhoa);
        for (chiTietNK ct : dscthd) {
            Vector r = new Vector();
            r.add(nuocUongDAO.timTenNuocTheoMa(ct.getMaNuoc()));
            r.add(ct.getSoLuong());
            r.add(ct.getGiaNhap());
    ...
    private void tbNKMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNKMousePressed
        // TODO add your handling code here:

        int row = tbNK.getSelectedRow();
        if (row >= 0) {
            String maNhap = modelTBNK.getValueAt(row, 0).toString().trim();
            this.setSize(WIDTH, HEIGHT);
            loadCTHD(maNhap);
            lbTitle.setText("DANH SÁCH CHI TIẾT PHIẾU NHẬP:" + maNhap.toUpperCase());
        }

    }//GEN-LAST:event_tbNKMousePressed
    ...
    private void tbNKMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNKMouseReleased
        // TODO add your handling code here:
        hoTro.offEdittingTable(tbNK);

    }//GEN-LAST:event_tbNKMouseReleased

    private void tbNKKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbNKKeyReleased
        // TODO add your handling code here:
        hoTro.offEdittingTable(tbNK);

    }//GEN-LAST:event_tbNKKeyReleased

    private void tbCTNKMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCTNKMouseReleased
        // TODO add your handling code here:
        hoTro.offEdittingTable(tbCTNK);

    }//GEN-LAST:event_tbCTNKMouseReleased

    private void tbCTNKKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbCTNKKeyReleased
        // TODO add your handling code here:
        hoTro.offEdittingTable(tbCTNK);

    }//GEN-LAST:event_tbCTNKKeyReleased
    ...
    private javax.swing.JTable tbCTNK;
    private javax.swing.JTable tbNK;
